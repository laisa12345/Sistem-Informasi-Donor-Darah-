...
public class DonorDrive {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("1. Tambah Donor (Lengkap)");
            System.out.println("2. Tambah Donor (Nama dan Umur)");
            System.out.println("3. Tampilkan Daftar Donor");
            ...
            if (pilihan == 1) {
                ...
                Donor donor = new Donor(nama, umur);
                daftarDonor.add(donor);
                System.out.println("Donor berhasil ditambahkan (hanya nama dan umur)!\n");
            } else if (pilihan == 3) {
