...
public class GUI_DonorDarah extends javax.swing.JFrame {
    ...
    private void btn_ProsesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ProsesActionPerformed
        ...
        try {
            ...
            String strUmur = txt_Umur.getText().trim();

            // Validasi kosong
            if (nama.isEmpty() || golonganDarah.isEmpty() || alamat.isEmpty() || strUmur.isEmpty()) {
                throw new IllegalArgumentException("Semua field harus diisi!");
            }

            // Validasi golongan darah (contoh: A+, AB-, O+)
            if (!golonganDarah.matches("^(A|B|AB|O)[+-]$")) {
                throw new IllegalArgumentException("Format golongan darah salah!\nContoh yang benar: A+, B-, AB+, O-");
            }
            ...
            if (umur < 17) {
                output += "\nStatus: BELUM CUKUP UMUR UNTUK DONOR\n";
            ...
            JOptionPane.showMessageDialog(this, e.getMessage(), "Input Tidak Valid", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
